<template>
  ...
  <div
  class="min-h-screen bg-gradient-to-br from-[#0b0f1a] to-[#05070d]
  text-gray-200 flex items-center justify-center"
  >
  
  <div
  class="w-[520px] bg-[#0f172a]/80 backdrop-blur-md
  ...
  <h2 class="text-xs tracking-widest text-gray-400">
  GAME MODE
  </h2>
